...
export default function FavoriteItem({ item, showVideo, removeFromFavs }) {
  let image = (
    <Image
      style={styles.image}
  ...
  return (
    <View style={styles.listItem}>
      ...
      <TouchableOpacity onPress={() => removeFromFavs(item)}>
        <View style={styles.fav}>
          ...
          <FontAwesome5 name="heart-broken" size={dimensions.small} color={favColor} />
        </View>
      </TouchableOpacity>
    </View>
  );
...
const styles = StyleSheet.create({
  listItem: {
    width: dimensions.channelImageSize + 20,
    alignItems: "center",
